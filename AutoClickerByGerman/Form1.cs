...
namespace AutoClickerByGerman
{
    public partial class Form1 : Form
    {
        ...
        // Declaraci�n de un objeto KeyboardHook
    ...
    private Thread? autoClickerThread;
        ...
        public Form1()
        {
            ...
            // Asociaci�n del evento KeyPressed al m�todo Form1_KeyPressed
            keyboardHook.KeyPressed += Form1_KeyPressed;
        }

        private const byte VK_2 = 0x32; // C�digo virtual para la tecla '2'

        private const byte VK_3 = 0x33;               // C�digo virtual para la tecla '3'
        ...
        {
            //mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0); // Presionar el bot�n izquierdo
            mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
            mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0); // Presionar el bot�n izquierdo
            mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);

            mouse_event(MOUSEEVENTF_RIGHTDOWN, 0, 0, 0, 0);
            mouse_event(MOUSEEVENTF_RIGHTUP, 0, 0, 0, 0); // Presionar el bot�n izquierdo
            mouse_event(MOUSEEVENTF_RIGHTDOWN, 0, 0, 0, 0);
            ...
            //mouse_event(MOUSEEVENTF_RIGHTDOWN, 0, 0, 0, 0); // Presionar el bot�n izquierdo
            //mouse_event(MOUSEEVENTF_RIGHTUP, 0, 0, 0, 0); // Presionar el bot�n izquierdo
        ...
        // M�todo que se llama cuando se detecta una pulsaci�n de tecla
        ...
        {
            ToggleAutoClicker(); // Alternar el estado del autoclicker cuando se hace clic en el bot�n
        }
